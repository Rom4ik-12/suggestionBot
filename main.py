...
ADMIN_IDS = [6617541179]   # ID админов
TARGET_CHAT_ID = -1002390894383  # ID группы/канала

# Тексты
TEXTS = {
    "must_join": "⚠️ Для использования бота нужно состоять в нашем канале.",
    "start": "📤 Привет! Отправь свой скриншот!.\n"
             "После модерации он будет опубликован.",
    "sent_for_review": "⏳ Ваша работа отправлена на модерацию. Ожидайте решения!",
    "approved": "✅ Ваша работа одобрена и опубликована!",
    "rejected": "❌ Ваша работа отклонена модератором.",
}
